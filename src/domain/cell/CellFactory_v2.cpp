#include "CellFactory_v2.h"
#include "../adapters/RandomNoise.h"

namespace domain {

std::unique_ptr<AgenticCell_v2> CellFactory_v2::createNormalCell(
    const Genome& genome,
...
std::unique_ptr<AgenticCell_v2> CellFactory_v2::createCustomCell(
    const Genome& genome,
    double neoplasm_k,
    ...
    return std::make_unique<AgenticCell_v2>(
        std::move(noise),
        genome,
        neoplasm_k,
