...
LEVEL1_CSV = DATA_DIR / "level_1" / "gen_07.csv"
LEVEL2_CSV = DATA_DIR / "level_2" / "gen_07.csv"
LEVEL3_CSV = DATA_DIR / "level_3" / "gen_07.csv"
SUMMARY_CSV = DATA_DIR / "sensitivity_summary.csv"
...
def main():
    print("Generating publication figures (Figura 2 y Figura 3)...")
    fig3_bimodality_decay_across_levels()
    fig4_tp53_threshold_behavior()
    print("Publication figures generated successfully in figures/!")
