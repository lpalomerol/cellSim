...
DATA_CSV = REPO_ROOT / "results" / "abc_sensitivity" / "level_1" / "gen_07.csv"
OUT_DIR = REPO_ROOT / "docs" / "paper20260828_1_validation_secondary" / "figures"
...
def main():
    levels = [
        ...
        ("level_2", "Nivel 2 (±25% - Variabilidad Moderada)", "fig_supp_s2_posterior_matrix_9x9_level2", "fig_supp_posterior_matrix_5x5_level2"),
        ("level_3", "Nivel 3 (±50% - Prueba de Estrés de Frontera)", "fig_supp_s3_posterior_matrix_9x9_level3", "fig_supp_posterior_matrix_5x5_level3"),
    ]
    ...
    for lvl_dir, lvl_title, supp_prefix_9x9, prefix_5x5 in levels:
        csv_path = REPO_ROOT / "results" / "abc_sensitivity" / lvl_dir / "gen_07.csv"
